  ...
  Yudai bietet günstiges, schnelles und modernes Webdesign speziell für kleine Unternehmen, Läden und Selbstständige.
              ...
              >
                <div className="rounded-md shadow hover-scale">
                  <Button className="w-full flex items-center justify-center px-8 py-3 bg-yudai-blue hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 transition-all duration-200">
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3 hover-scale">
                  <Button variant="outline" className="w-full flex items-center justify-center px-8 py-3 transition-all duration-200">
                    <Link to="/portfolio">
                      Beispiele ansehen
                    </Link>
                  </Button>
