      ...
      <section className="py-12 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center mb-12">
            <h2 className="text-base text-yudai-green font-semibold tracking-wide uppercase">Unsere Templates</h2>
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-4xl">
              Schnellstartlösungen für Ihren Webauftritt
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 dark:text-gray-400 lg:mx-auto">
              Für noch schnellere Ergebnisse bieten wir fertige Vorlagen an, die wir für Ihre Bedürfnisse anpassen können.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col">
              <div className="h-48 overflow-hidden border-b border-gray-200 dark:border-gray-700">
                <img 
              ...
              <div className="p-6 flex-grow">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Business Basic</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Perfekt für kleine Unternehmen und Startups. Enthält alle wichtigen Elemente für Ihren Webauftritt.
                </p>
              ...
              <div className="p-6 bg-gray-50 dark:bg-gray-700">
                <Button className="w-full bg-yudai-blue hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700">
                  Mehr erfahren
                </Button>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col">
              ...
              <div className="p-6 flex-grow">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Shop Standard</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Ideal für kleine Online-Shops und Händler. Mit allen nötigen E-Commerce Funktionen.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center text-gray-600 dark:text-gray-300">
                    <svg className="h-5 w-5 mr-2 text-yudai-green" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col">
              ...
              <div className="p-6 flex-grow">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Service Pro</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Speziell für Dienstleister und Freiberufler mit Online-Terminbuchung.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center text-gray-600 dark:text-gray-300">
                    <svg className="h-5 w-5 mr-2 text-yudai-green" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
